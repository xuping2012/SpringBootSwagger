...
public class JSONExtractor {
	...
	/**
	 *  1 json解析方法,在jmeter当中可以通过String res=prev.getResponseDataAsString();获取响应报文字符串格式；
	 *  通过JSONObject responseJson = JSON.parseObject(res);转成json对象；然后再调用此方法，jpath写法：如果是[]数组则需要携带角标取值，如果是{}则/取值
	 * @param responseJson
...
////		String name = JSONExtractor.getValueByJPath(responseJson,"results[0]/index[0]/test/noa");
